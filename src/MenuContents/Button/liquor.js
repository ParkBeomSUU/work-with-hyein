...
<>
    ...
    <div id="PlusMa">
            <Button  id="Plus" onClick={() => setVolume({
                ...volume, Jagermeilter: volume.Jagermeilter === 10 ? 10 : volume.Jagermeilter + 1
            })}>+ </Button>
            <div id="Count"> {volume.Jagermeilter} </div>
            <Button  id="Minus"  onClick={() => setVolume({
                ...volume, Jagermeilter: volume.Jagermeilter === 0 ? 0 : volume.Jagermeilter - 1
            })}>- </Button>
            </div>
    ...
    <div id="PlusMa">
            <Button  id="Plus" onClick={() => setVolume({
                ...volume, JimBeam: volume.JimBeam === 10 ? 10 : volume.JimBeam + 1
            })}>+ </Button>
            <div id="Count"> {volume.JimBeam} </div>
            <Button  id="Minus"  onClick={() => setVolume({
                ...volume, JimBeam: volume.JimBeam === 0 ? 0 : volume.JimBeam - 1
            })}>- </Button>
            </div>
    </Col>
    ...
    <div id="PlusMa">
            <Button  id="Plus" onClick={() => setVolume({
                ...volume, Tina: volume.Tina === 10 ? 10 : volume.Tina + 1
            })}>+ </Button>
            <div id="Count"> {volume.Tina} </div>
            <Button  id="Minus"  onClick={() => setVolume({
                ...volume, Tina: volume.Tina === 0 ? 0 : volume.Tina - 1
            })}>- </Button>
            </div>
    ...
    <div id="PlusMa">
            <Button  id="Plus" onClick={() => setVolume({
                ...volume, TheClass33: volume.TheClass33 === 10 ? 10 : volume.TheClass33 + 1
            })}>+ </Button>
            <div id="Count"> {volume.TheClass33} </div>
            <Button  id="Minus"  onClick={() => setVolume({
                ...volume, TheClass33: volume.TheClass33 === 0 ? 0 : volume.TheClass33 - 1
            })}>- </Button>
            </div>   
    </Col>
    </Row>
    ...
    <div id="PlusMa">
    <Button  id="Plus" onClick={() => setVolume({
                ...volume, Macallan12: volume.Macallan12 === 10 ? 10 : volume.Macallan12 + 1
            })}>+ </Button>
            <div id="Count"> {volume.Macallan12} </div>
            <Button  id="Minus"  onClick={() => setVolume({
                ...volume, Macallan12: volume.Macallan12 === 0 ? 0 : volume.Macallan12 - 1
            })}>- </Button>
            </div>   
    ...
    <Button  id="Plus" onClick={() => setVolume({
                ...volume, TellinfSingleMalt: volume.TellinfSingleMalt === 10 ? 10 : volume.TellinfSingleMalt + 1
            })}>+ </Button>
            <div id="Count"> {volume.TellinfSingleMalt} </div>
            <Button  id="Minus"  onClick={() => setVolume({
                ...volume, TellinfSingleMalt: volume.TellinfSingleMalt === 0 ? 0 : volume.TellinfSingleMalt - 1
            })}>- </Button>
            </div>   
